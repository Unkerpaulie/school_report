"""
Base Django settings for school_report project.
...
# Note: BASE_DIR is now 3 levels up from this file (settings/base.py)
...
WSGI_APPLICATION = 'school_report.wsgi.application'
