...
class UserProfileInline(admin.StackedInline):
    ...
    fields = ('user_type', 'phone_number', 'must_change_password', 'title', 'position', 'transfer_notes')
    ...
    def get_formset(self, request, obj=None, **kwargs):
        ...
        if not obj:  # This is a new user being created
            ...
            formset.form.base_fields['user_type'].initial = 'administration'
...
class CustomUserAdmin(UserAdmin):
    ...
    # School relationship is now handled through SchoolStaff model
...
class UserProfileAdmin(admin.ModelAdmin):
    list_display = ('get_full_name', 'user_type', 'contact_email', 'phone_number', 'is_active')
