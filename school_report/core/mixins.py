...
class SchoolAdminRequiredMixin:
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        # Check if user is a non-teaching staff (staff members can access any school)
        is_staff = request.user.profile.user_type == 'staff'
        
        # Allow access if user is either a principal of this school or a staff member
        if is_principal or is_staff:
...
class SchoolAccessRequiredMixin:
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        # Allow access if user is either a principal, staff member, or teacher at this school
        if is_principal or is_staff or is_teacher:
            return super().dispatch(request, *args, **kwargs)
